...
const CaptureLocation = () => {
  ...
  return (
    <CommonLayout back={role == 'Medical' ? ROUTE_MAP.assessment_type : ROUTE_MAP.medical_assessments} 
      ...
      <div className="flex flex-col px-6 gap-5 pb-5">
...

          {
            ...
            (
              <iframe
                ...
                loading="lazy"
                title="map"
                className="animate__animated animate__fadeIn h-[55vh]"
              />
            )
          }
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          {/* <Button
            ...
            styles={
              disabled
                ? "bg-white text-primary opacity-75 animate__animated animate__fadeInDown"
